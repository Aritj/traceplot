...
def main(target: str) -> None:
    ...
    """
    target_ip = tools.get_ip_from_fqdn(target) if not target.replace(".", "").isdigit() else target
    ...
    print(f"Public IP (geolocation starting point): {public_ip}{' | Behind NAT' if behind_nat else ''}")
